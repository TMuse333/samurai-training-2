...
import { BaseComponentProps, GradientConfig } from "@/types";

export interface MarketingShowcaseProps extends BaseComponentProps {
  title: string;
  subTitle: string;
  description: string;
  textArray: {
...
const MarketingShowcase: React.FC<MarketingShowcaseProps> = ({
  title,
  subTitle,
  description,
  textArray,
